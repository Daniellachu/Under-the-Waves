...
import styles from "@/components/af-popup/af.module.css"
    ...
    return(
        <>  
            <div className={styles.container}>
                <Image className={styles.fishFloat} src={"/animals/angler-fish.png"} height={150} width={150} onClick={()=> setIsShown(true)} />
                {isShown &&(
                    <div className={styles.popup}>
                        ...
                        <div className={styles.generalInfo}>
                            <Image id="atlanticSalmon"src={"/animals/angler-fish.png"} height={80} width={80}></Image>
                            <div id="General" class="info" style={{display:"block"}}>
                                <div id="general">
                                    { data && data.map((info,index) => {
                                        if (info.name === "Anglerfish"){
                                        return (
