...
import styles from "@/components/cn-popup/cn.module.css"

export default function ChamberedNautilus(){   
    ...
    return(
        <>  
            <div className={styles.container}>
                <Image className={styles.fishFloat} src={"/animals/chambered-nautilus.png"} height={100} width={100} onClick={()=> setIsShown(true)} />
                {isShown &&(
                    <div className={styles.popup}>
                        ...
                        <div className={styles.generalInfo}>
                            <Image id="atlanticSalmon"src={"/animals/chambered-nautilus.png"} height={80} width={80}></Image>
                            <div id="General" class="info" style={{display:"block"}}>
                                <div id="general">
                                    { data && data.map((info,index) => {
                                        if (info.name === "Chambered Nautilus"){
                                        return (
