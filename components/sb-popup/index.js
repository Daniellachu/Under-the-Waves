...
import styles from "@/components/sb-popup/sb.module.css"

export default function StripedBass(){   
    ...
    return(
        <>  
            <div className={styles.container}>
                <Image className={styles.fishFloat} src={"/animals/striped-bass.png"} height={120} width={120} onClick={()=> setIsShown(true)} />
                {isShown &&(
                    <div className={styles.popup}>
                        ...
                        <div className={styles.generalInfo}>
                            <Image id="atlanticSalmon" src={"/animals/striped-bass.png"} height={80} width={80}></Image>
