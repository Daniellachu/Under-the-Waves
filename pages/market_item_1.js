...
export default function Shopitem_1() {
    ...
    return(
        <>
            <Head>
            <title>Under the Waves | Moss</title>
                    ...
                    <div className={styles.content}>
                        <div className={styles.content_top_part}>
                            ...
                            <div className={styles.right_part}>
                                <p className={styles.heading}>Moss</p>
                                ...
                                <div className={styles.qty}>
                                    ...
                                    <div className={styles.qty_buttons}>
                                        <div onClick={() => {(number_amount === 0 ) ? setNumber_amount(0) : setNumber_amount(number_amount - 5)}}>
                                            <Image
                                        ...
                                        <div onClick={() => setNumber_amount(number_amount + 5)}>
                                            <Image
                                        ...
                                        <div className={styles.popup}>
                                            ...
                                            <p>Do you want to spend 
                                                <Image 
                                                    ...
                                                    height={20}
                                                />
                                                <span className={styles.color_pink}>{number_amount}</span> to buy <span className={styles.color_green}>{number} moss</span>?</p>
                        ...
                        <div className={styles.middle_part}>
                            <p>
                                Adding <span className={styles.color_green}>moss</span> to your aquarium can provide both functional and aesthetic benefits for your <span className={styles.color_blue}>fishes</span> and the overall ecosystem.
                            </p>
                        </div>
                            ...
                            <div className={styles.details}>
                                <div className={styles.points}>
                                    <Image
                                        ...
                                        height={30}
                                    />
                                    <p>Provides oxygenation for <span className={styles.color_blue}>fishes</span> and other <span className={styles.color_blue}>aquatic creatures</span>.</p>
                                </div>
                                <div className={styles.points}>
                                    <Image
                                        className={styles.star}
                                        ...
                                        height={30}
                                    />
                                    <p>Act as a <span className={styles.color_green}>natural filter</span> because it absorbs excess nutrients and debris in the water.</p>
                                </div>
                                <div className={styles.points}>
                                    <Image
                                        className={styles.star}
                                        ...
                                        height={30}
                                    />
                                    <p>Serves as a natural-looking decoration.</p>
                                </div>
                            </div>
                        </div>
                    </div>
